...
function Deeprot_Stomper_OnLeaveCombat(Unit)
	Unit:RemoveEvents()
end
...
function Deeprot_Tangler_OnLeaveCombat(Unit)
	Unit:RemoveEvents()
end
...
function Diemetradon_OnLeaveCombat(Unit)
	Unit:RemoveEvents()
end
...
function Hydra_OnLeaveCombat(Unit)
	Unit:RemoveEvents()
end
...
function Pre_Behemoth_OnLeaveCombat(Unit)
	Unit:RemoveEvents()
end
]]--
...
function Barbed_Lasher_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Constrictor_Vine_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Creeping_Sludge_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Cavern_Shambler_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Celebrian_Dryad_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Meshlok_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Noxious_Slime_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Poison_Sprite_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Corruptor_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Putridus_Trickster_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Spewed_Larva_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Vine_Larva_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
...
function Putridus_Shadowstalker_OnLeaveCombat(Unit)
Unit:RemoveEvents()
end
