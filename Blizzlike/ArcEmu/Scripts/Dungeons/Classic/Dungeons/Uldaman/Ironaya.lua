...
arcing=3000+math.random(1,10000)
	
Unit:SendChatMessage(14, 0, "Nobody steals the secrets of the Creator!") -- this is blizzlike 
...
function Ironaya_OnKilledTarget(Unit, Event)
end
...
RegisterUnitEvent(7228, 3, "Ironaya_OnKilledTarget")
